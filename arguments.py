...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        type=str,
        default="",
        help="Prefix for video paths"
    )
    parser.add_argument(
        "--video_min_short_side_scale",
        type=int,
        default=256,
        help="Minimum short side scale for videos",
    )
    parser.add_argument(
        "--video_max_short_side_scale",
        type=int,
        default=320,
        help="Maximum short side scale for videos",
    )
